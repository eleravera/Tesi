\section{Charaterization}
    ...
    \begin{frame}
        \frametitle{Threshold and noise}
        \centering
        \includegraphics[width=.75\linewidth]{figures/charaterization/threshold_noise_maps.pdf}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \column{0.33\textwidth}  
                \includegraphics[width=1.1\linewidth]{figures/Monopix1/pulse_60to10.png}
            \column{0.33\textwidth}
