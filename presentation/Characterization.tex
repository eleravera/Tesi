\section{Characterization}
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \column{0.45\textwidth} 
                %Noise rate with this FE setting $\sim$\SI{3}{Hz} on 25088 pixels
                \begin{itemize}
        ...
        \begin{columns}
            ...
            \column{0.8\textwidth} 
                ...
                \begin{table}
                    ...
                    \hline
                    \hline
                    Threshold [$e^-$] & 350 $\pm$ 35 & 368 $\pm$ 35 & 420 $\pm$ 35\\
                    Noise [$e^-$] & 10.9 $\pm$ 1.4 & 10.9 $\pm$ 1.4 & 14.4 $\pm$ 1.8\\
                    \hline
                    \end{tabular}}
                    \end{center}
                \end{table}
    ...
    \begin{frame}
        ...
        \begin{columns}
            \column{0.55\textwidth}              
                \includegraphics[width=1.07\linewidth]{figures/charaterization/deadtime_presentazione.pdf}
            \column{0.45\textwidth}  
