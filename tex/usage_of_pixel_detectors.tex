In the following sections I will use terms such as hybrid pixels, monolitich active picel system (MAPS), Charge Coupled Devices (CCDs), Depleted Field Effect Transistor sensors (DEPFET) that will discussed in \ref{chap:pixel} \red{disclaimer}
...
This chapter tries to summarize the main applications of pixel detectors, while a description of the technological implementation is presented in \ref{chap:pixel}
