...
\section{Other applications}
    ...
    \subsubsection{Dosimetric problems}
        Finding dosimeters suitable for ultra high dose rate is an issue. 
        Indeed, \red{mentre il problema non si pone con passive dosimeters}, all the active ones for online monitoring of the beam show saturation problems. 
        \red{On the other hand passive dosimeters could provide dosimetric data, showing dose-rate independence up to 10 alla nove Gy/s for radiochromic films. Cosa sono i radiochromic films and they do not have the same accuracy of other detectors.}

        The principal detectors for online measurement are ionization chambers, that show saturation issue at dose per pulse (DDP) two orders of magnitude lower than the ones used for FLASH-RT.
        \red{da qui in poi}
