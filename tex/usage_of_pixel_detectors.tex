...
\section{Tracking in HEP}
    ...
    \subsection{Hybrid pixels at LHC: ATLAS, CMS and LHC-b}
        ...
        \red{hich appears as a circumstance whereby a imaging-pourpose detector has been adopted in a HEP experiment.}
...
\section{Applications in imaging}
    The counting mode represents the principal imaging tecnique used by detectors: \red{l'obiettivo è tipicamente o single particle count, }

    Two noteworthy of microchips originally meant
    ...
    The aim of the fourth collaboration (2016), instead, is designing pixel read-out chips that prepared for \red{TSV processing and may be tiled on all four sides. }
    ...
    \red{Timepix Detector for Imaging in Ion Beam Radiotherapy}
