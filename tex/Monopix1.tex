...
\subsection{The sensor}\label{chapter:TJMonopix1_thesensor}
    ...
    \subsection{Front end}\label{sec:ALPIDE-like}
        ...
        The matrix is split in four sections, each one corresponding to a slightly different flavor of the FE, implemented in order to test more options. 
        \begin{figure}[h!]
            \centering
        ...
        Moreover the collection electrode can be either DC-coupled to the readout electronics, as in flavors A, B, C, or AC-coupled through a metal-oxide-metal capacitance, as in D is AC-coupled. The latter one allows applying a high bias voltage to the electrode $n$ and for this reason the flavor D is also called "HV flavor".
...
\subsection{Readout logic}\label{chap:Monopix_RO}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[clip,width=0.69\linewidth]{figures/Monopix1/TJMonopix1_board_commented.png}
        \end{subfigure}
