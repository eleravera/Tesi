...
\section{Readout logic}
    \red{ The simplest readout is “rolling shutter”, in which peripheral logic along the chip edge addresses rows in turn, and analogue signals are transmitted by column lines to peripheral logic at the bottom of the imaging area.}
    ...
    \subsection{Dead time measurements}
        ...
        \red{Un esempio se leggo un singolo pixel: LA SLOPE CON CUI L'EFFICIENZA SCENDE È ABBSTANZA UNIFORME? perchè satura a 50?}
        ...
        \red{A tutte le hit di una iniezione che arrivano contemporaneamente viene assegnato lo stesso timestamp; Risoluzione temporale??}
