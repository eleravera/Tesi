...
\section{The sensor}\label{chapter:TJMonopix1_thesensor}
    ...
    \section{Front end}
        ...
        \subsection{ALPIDE-like}\label{sec:ALPIDE-like}
...
\section{Readout logic}\label{chap:Monopix_RO}
