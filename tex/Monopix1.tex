...
\section{Injection}
        \begin{itemize}
        \item check sul chi quadro: fai un istogramma del chi quadro con fit retta e parabola
        \item mappe dei parametri per un flavor
        \end{itemize}
...
%python3 -i calibration/tot_histo2d.py -f calibration/calibration_data/PMOS/20220506 per fare l'istogramma 2d del tot
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.6\linewidth]{figures/Monopix1/plot/ToT_rollover.png}
        \caption{ToT rollover for pixel (10,10). The ToT is in range 0-64 since it is represented by 6 bit. }
        \label{fig:ToT_rollover}
    \end{figure}   
    
        \begin{figure}[h!]
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.98\linewidth]{figures/Monopix1/plot/scurve.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.98\linewidth]{figures/Monopix1/plot/ToT_injection.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
        \end{figure}    
        ...
        \begin{figure}[h!]
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.99\linewidth]{figures/Monopix1/plot/threshold_histogram.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.99\linewidth]{figures/Monopix1/plot/noise_histogram.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
        \end{figure}            
        \begin{figure}[h!]
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.98\linewidth]{figures/Monopix1/plot/slope_histogram.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
            \begin{subfigure}{.5\textwidth}
            \centering
            \includegraphics[width=.98\linewidth]{figures/Monopix1/plot/intercept_histogram.png}
            \caption{}
            \label{fig:}
            \end{subfigure}
        \end{figure} 
...
\section{Calibration of the ToT signal}
    ...
    Istogramma di singolo pixel del ferro
    Mappa dei parametri del fit sulla matrice (media e sigma)
  
    
\section{Fe vs bias}
    rate vs bias 
    posizione del picco del ferro vs bias    
