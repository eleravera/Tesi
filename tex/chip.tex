...
\section{CCDs}
ens of ms due to the need to transfer the charge signals pixel by pixel through a single output circuit
For photon imaging the need of high assorbtion efficiency 

\section{Hybrid pixels}
   \red{METTI IN EVIDENZAZ CHE PUOI FARE UN READOUT CON TECNOLOGIA CMOS}
